...
## About
This repository contains the source code for Spike's [Fore Thought Engine](https://fte.triptohell.info/about), featuring basic modifications specific to NZ:P such as parity changes for external texture lookups, a custom configuration header, etc. Due to the lack of substantial changes, this fork isn't necessarily required for CSQC-FTE-based NZ:P builds to function.
